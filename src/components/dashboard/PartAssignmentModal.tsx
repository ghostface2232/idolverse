        ...
        >
          ...
          >
            ...
            <span className="mt-1 block text-pretty text-xs leading-5 text-text-muted">
              킬링파트와 무대 동선을 1~2인에게 몰아줍니다. 곡·안무 완성도가
              크게 오르고 푸시 멤버의 개인 인기가 성장하지만, 나머지 멤버의
              만족도가 떨어집니다.
            </span>
          </Radio>
          <Radio
          ...
          >
            ...
            <span className="mt-1 block text-pretty text-xs leading-5 text-text-muted">
              파트와 노출을 고르게 나눕니다. 팀 만족도와 케미가 오르지만
              완성도 상승은 완만하고, 화제의 중심이 될 얼굴은 만들어지지
              않습니다.
            </span>
          </Radio>
        </RadioGroup>
              ...
              {trainees.map((trainee) => {
                ...
                return (
                  <button
                    ...
                    className={[
                      "flex min-h-11 w-full items-center gap-2.5 rounded-xl border-2 px-3 py-2 text-left outline-none transition duration-150 ease-out active:scale-[0.98]",
                      selected
                        ? "border-brand-cyan/60 bg-brand-cyan/[0.08]"
                  ...
                  >
                    ...
                    <span className="min-w-0 flex-1 text-xs">
                      ...
                      <span className="mt-0.5 block text-text-muted">
                        보컬 {trainee.stats.vocal} · 댄스 {trainee.stats.dance}{" "}
                        · 인기 {Math.round(trainee.popularity ?? 0)}
                      </span>
                    </span>
                    {selected ? (
                      <span className="shrink-0 rounded-md bg-brand-cyan/20 px-1.5 py-0.5 text-[10px] font-semibold text-cyan-200">
                        푸시
                      </span>
                    ) : null}
                  </button>
