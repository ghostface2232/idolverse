...
const initialTrainees: Trainee[] = [
  {
    ...
    conceptAffinity: createAffinity({ fresh: 88, emotional: 78, dark: 35 }),
    mood: 74,
    stress: 31,
    condition: 79,
    satisfaction: 77,
  ...
  },
  {
    ...
    position: "mainDancer",
    subPosition: "center",
    conceptAffinity: createAffinity({ y2k: 84, summer: 82, retro: 68 }),
    mood: 69,
    stress: 36,
    condition: 76,
    satisfaction: 74,
  ...
  },
  {
    ...
    position: "visual",
    subPosition: "variety",
    conceptAffinity: createAffinity({ girlCrush: 80, dark: 76, cute: 28 }),
    mood: 72,
    stress: 28,
    condition: 80,
    satisfaction: 71,
  ...
  },
  {
    ...
    position: "mainVocal",
    subPosition: null,
    conceptAffinity: createAffinity({ emotional: 86, winter: 72, girlCrush: 24 }),
    mood: 77,
    stress: 24,
    condition: 82,
    satisfaction: 79,
  ...
  },
  {
    ...
    position: "variety",
    subPosition: "center",
    conceptAffinity: createAffinity({ fresh: 76, cute: 71, summer: 79 }),
    mood: 68,
    stress: 38,
    condition: 73,
    satisfaction: 70,
